...
const Header = () => {
  ...
  return (
    ...
    <header className="text-gray-400 bg-indigo-700 body-font">
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center" style={opacColor}>
    <a className="flex title-font font-medium items-center text-white mb-4 md:mb-0">
    <img src={logo1} alt="Logo" className='w-14 h-14 text-white p-2  rounded-full' />

    

      <span className="ml-3 text-xl">Shoaib-Clothing</span>
    </a>
    <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-700	flex flex-wrap items-center text-base justify-center">
      ...
      <NavLink to="/products" className="mr-5 hover:text-white">Products</NavLink>     
